...
model_path = "saved_models/spine_model_epoch_4_dice_0.6411.pth"  # Load trained model
output_dir = "benchmark_predictions_spine/"
...
print("\n🔹 Benchmark Testing Completed! Predictions saved in 'benchmark_predictions_spine/'")
