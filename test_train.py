...
class ProbabilisticUnet(nn.Module):
    ...
    def reconstruct(self, use_posterior_mean=False, calculate_posterior=False, z_posterior=None,training=True):
        ...
        - During training, uses the posterior latent space.
        - During testing or if the posterior latent space is unavailable, falls back to the prior latent space.
        
        Args:
            use_posterior_mean (bool): Whether to use the mean of the posterior latent space.
            calculate_posterior (bool): Whether to sample or calculate from the posterior.
            z_posterior (torch.Tensor): A specific latent sample provided externally.
